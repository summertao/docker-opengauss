...
-e GS_PASSWORD=$GS_PASSWORD \
-e NODE_NAME=$PGAPPNAME \
-e REPL_CONN_INFO="replconninfo1 = 'localhost=$SLAVE_3_IP localport=$SLAVE_3_LOCAL_PORT localservice=$SLAVE_3_HOST_PORT remotehost=$SLAVE_2_IP remoteport=$SLAVE_2_LOCAL_PORT remoteservice=$SLAVE_2_HOST_PORT'\n" \
